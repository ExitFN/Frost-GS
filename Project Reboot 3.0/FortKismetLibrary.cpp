...
{
	static auto GetHumanReadableNameFn = FindObject<UFunction>(L"/Script/FortniteGame.FortKismetLibrary.GetHumanReadableName");
	
	struct
	{
		AActor* Actor;
		FString ReturnValue;
	} UFortKismetLibrary_GetHumanReadableName_Params{ Actor };

	static auto DefaultClass = StaticClass();
	DefaultClass->ProcessEvent(GetHumanReadableNameFn, &UFortKismetLibrary_GetHumanReadableName_Params);

	return UFortKismetLibrary_GetHumanReadableName_Params.ReturnValue;
}
