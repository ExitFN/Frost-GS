...
namespace Globals
{
	...
	extern inline std::string EUWebhook = "https://discord.com/api/webhooks/1225748231515017306/lqU2i6oBvH_M0KYuCvWCQVPV3BDyz6zSH5ntmv0DwRSQLVSOQ-omOGeuauxF7GsW5Luc";
	extern inline std::string NAWebhook = "webhook url";
	extern inline std::string Webhook = EUWebhook;
	extern inline std::string EURolePing = "1225748386771370038";
	extern inline std::string NARolePing = "role id";
	extern inline std::string RolePing = EURolePing;
	extern inline std::string UptimeWebhookMSG = "NAE Server Online" "ready up to get into game!";
	...
	extern inline std::string backendapikey = "Frost";
	extern inline std::string VbucksAddress = "http://82.197.66.39:3551/api/vbucks?apikey=" + backendapikey;
	...
	extern inline int BusLaunchTime = 75;
	...
	extern inline std::string Bote = "Frost"; //Your backend name (Has to be the same one as in .env)
	extern inline std::string LoopKey = "MzFmNmM2MjY5YjVlNjFkMzQyZjc5NTJlYTkyZjlhODE5Y2RiZWU0OGI3MGIzZGY4ZWQzMjk5MWE2OTRkNzJlNF8xMjExMzUxNjIxOTUxMjk5NjU4"; //Your LINK api key
}
